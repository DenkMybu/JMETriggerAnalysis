...
input_file_dir = '/afs/cern.ch/user/r/rhaberle/CMSSW_12_4_12/src/JMETriggerAnalysis/NTuplizers/test/'
...
config.JobType.maxJobRuntimeMin = 500 # minutes
...
config.Data.outLFNDirBase = '/store/user/rhaberle/'+store_dir+'/'+sample_name
