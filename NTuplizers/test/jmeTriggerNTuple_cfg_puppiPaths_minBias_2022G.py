...
opts.register('output', 'out_minBias_2022G.root',
              vpo.VarParsing.multiplicity.singleton,
              vpo.VarParsing.varType.string,
...
if opts.reco == 'HLT_oldJECs':
  ...
  from JMETriggerAnalysis.Common.configs.HLT_dev_CMSSW_12_4_0_GRun_era2022G_MinnBias_configDump import cms, process
  update_jmeCalibs = False  
...
if opts.inputFiles:
 ...
 # '/store/mc/Run3Winter22DR/SingleNeutrino_E-10-gun/GEN-SIM-DIGI-RAW/L1TPU0to99FEVT_SNB_122X_mcRun3_2021_realistic_v9-v2/70007/98c44c2f-d5b4-49b3-a2bf-a709898dd8cd.root' 
  ...
  '/store/data/Run2022G/MinimumBias/MINIAOD/PromptReco-v1/000/362/361/00000/c9d26db7-1b18-4b68-b346-a948552ce292.root'
...
if opts.secondaryInputFiles:
  ...
  process.source.secondaryFileNames = [
    ...
    '/store/data/Run2022G/MinimumBias/RAW/v1/000/362/361/00000/62962bfa-ce8e-4581-a855-c91003d107db.root',
    #'/store/data/Run2022D/JetMET/RAW/v1/000/357/538/00000/090c78ea-c171-420a-a080-1d12cedac27b.root',
