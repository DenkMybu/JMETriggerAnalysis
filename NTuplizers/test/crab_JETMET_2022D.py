...
config.General.requestName = 'JETMET_2022D_raw_v5'
...
config.JobType.psetName = '/afs/cern.ch/user/r/rhaberle/CMSSW_12_4_12/src/JMETriggerAnalysis/NTuplizers/test/jmeTriggerNTuple_cfg_puppiPaths.py'
...
config.Data.inputDataset = '/JetMET/Run2022D-v1/RAW'
