...
opts.register('dumpPython', 'config_jetmet_2022F.py',
              vpo.VarParsing.multiplicity.singleton,
...
opts.register('output', 'out_JetMET_2022G.root',
              vpo.VarParsing.multiplicity.singleton,
              vpo.VarParsing.varType.string,
...
if opts.reco == 'HLT_oldJECs':
  ...
  from JMETriggerAnalysis.Common.configs.HLT_dev_CMSSW_12_4_0_GRun_era2022G_JetMET_configDump import cms, process
  update_jmeCalibs = False  
...
if opts.inputFiles:
 ...
 # '/store/mc/Run3Winter22DR/SingleNeutrino_E-10-gun/GEN-SIM-DIGI-RAW/L1TPU0to99FEVT_SNB_122X_mcRun3_2021_realistic_v9-v2/70007/98c44c2f-d5b4-49b3-a2bf-a709898dd8cd.root' 
  ...
  '/store/data/Run2022G/JetMET/MINIAOD/PromptReco-v1/000/362/437/00000/d6f675c4-61c4-4185-8f9c-d5763b0177d8.root'
...
if opts.secondaryInputFiles:
  ...
  process.source.secondaryFileNames = [
    ...
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/00e9fe00-4366-4a2c-ac1f-d0918d94912a.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/1aa19628-fced-4a83-bd03-a2f6e06ae524.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/2676e16d-3d12-4959-afa3-67925a1e823d.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/2bf74646-758c-4992-9f5e-ec70395b23f9.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/498c1370-6ec1-4dff-bb7c-4e118692b198.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/5ef9666b-971d-41f1-b151-4090ab8a0ce1.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/64cbc9a2-6d00-4abe-9320-ac9ee4457395.root',
    '/store/data/Run2022G/JetMET/RAW/v1/000/362/437/00000/f01048ac-c81d-4d6f-890e-c3e3d39a70f7.root',
